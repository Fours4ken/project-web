            		...
            		<div class="row">
            			<div class="col-lg col-md-12 col-12">
            				<div class="your-order">
            					<h3 class="text-center">Your order # 0001-0001</h3>
            					<div class="your-order-table table-responsive">
            						<table>
            							<tbody>
                                            ...
                                            <tr>
                                                <td colspan ="4" class="order-button-payment"><a class="btn-style" href="<?= base_url('home/booking/').$check['id']; ?>">SELESAI & LANJUTKAN PEMESANAN</a></td>
                                            </tr>
											<tr>
												<td colspan="4"><a href="<?= base_url('home/cancel/').$check['id']; ?>" class="btn btn-outline-danger">Klik Disini Jika Batal Rental...</a></td>
											</tr>
            							</tbody>
            						</table>
            					</div>
